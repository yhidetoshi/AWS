...
unicorn['worker_timeout'] = 200
unicorn['worker_processes'] = 2

## Advanced settings
unicorn['listen'] = '10.0.1.46'
unicorn['port'] = 60080
...
#nginx['listen_port'] = 8000 # override only if you use a reverse proxy: https://gitlab.com/gitlab-org/omnibus-gitlab/blob/master/doc/settings/nginx.md#setting-the-nginx-listen-port
